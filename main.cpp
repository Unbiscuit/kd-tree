...
void test_wikipedia() {
    ...
    tree2d tree(begin(points), end(points));
    point2d n = tree.nearest({ 9, 2 });

    cout << "Wikipedia example data:\n";
    cout << "nearest point: " << n << '\n';
    cout << "distance: " << tree.distance() << '\n';
    cout << "nodes visited: " << tree.visited() << '\n';
}
...
struct random_point_generator {
    random_point_generator(double min, double max)
            : engine_(random_device()()), distribution_(min, max) {}
